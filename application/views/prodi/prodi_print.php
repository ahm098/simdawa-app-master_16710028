...
$pdf->Cell(6, 1, "ID", 1, 0, "C", true);
$pdf->Cell(12, 1, "Nama Prodi", 1, 1, "C", true);
$pdf->SetFont("Arial", "", 11);
$no = 1;
if (!empty($prodi)) {
    foreach ($prodi as $a) {
        $pdf->Cell(1, 1, $no++, 1, 0, "C");
        $pdf->Cell(6, 1, $a->id, 1, 0, "C");
        $pdf->Cell(12, 1, $a->nama_prodi, 1, 1, "C");
    }
} else {
    $pdf->Cell(19, 1, "Tidak ada data prodi.", 1, 1, "C");
}
